    ...
    <>
      ...
      <section className="py-8 md:py-12 lg:py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Booking Disclaimer */}
          <FadeIn delay={0.1}>
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6 md:mb-8">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm text-yellow-800">
                  ...
                  <a 
                    ...
                    className="inline-flex items-center mt-2 bg-[#25D366] hover:bg-[#128C7E] text-white py-2 px-4 rounded-lg transition-colors font-medium shadow-sm"
                    target="_blank"
