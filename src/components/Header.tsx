        ...
        <div className="flex justify-between items-center py-2 md:py-3">
          ...
          >
            <ul className="flex items-center space-x-4 xl:space-x-6">
              ...
              <li>
                <Link href="/drinks-menu" className="text-white hover:text-gray-200 px-3 py-2 text-sm font-medium transition-colors">
                  Drinks Menu
                </Link>
              </li>
              <li>
          ...
          >
            <button
              ...
              className="inline-flex items-center justify-center gap-2 p-2 rounded-md text-white hover:text-gray-200 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
