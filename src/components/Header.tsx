          ...
          <nav className="hidden md:block" role="navigation" aria-label="Main navigation">
            <ul className="flex items-center space-x-8">
              ...
              <li>
                ...
                <Link 
                  href="/reservations" 
                  className="bg-red-600 text-white px-6 py-2 hover:bg-red-700 transition-colors font-medium"
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <div className="pt-4 pb-3 border-t border-white/20">
                <Link
                  href="/reservations"
                  className="block w-full bg-red-600 text-white px-6 py-3 hover:bg-red-700 transition-colors font-medium text-center"
                  onClick={() => setIsMenuOpen(false)}
                  aria-label="Make a reservation now"
                >
                  Book Now
