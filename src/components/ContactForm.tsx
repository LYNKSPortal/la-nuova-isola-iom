                  ...
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-[#7A2325] 600 rounded-full flex items-center justify-center">
                      <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M12.04 2c-5.463 0-9.904 4.442-9.904 9.904 0 1.744.452 3.384 1.246 4.812L2.04 22l5.524-1.736c1.33.748 2.865 1.176 4.476 1.176 5.463 0 9.904-4.442 9.904-9.904S17.503 2 12.04 2zm0 17.917c-1.364 0-2.667-.362-3.784-1.004l-.272-.164-2.82.889.894-2.746-.162-.272c-.696-1.145-1.064-2.465-1.064-3.842 0-4.018 3.27-7.288 7.288-7.288 1.947 0 3.777.758 5.154 2.135 1.376 1.376 2.134 3.207 2.134 5.154 0 4.018-3.27 7.288-7.288 7.288zm3.814-5.229c-.209-.104-1.236-.611-1.428-.682-.191-.071-.331-.104-.471.104-.141.209-.546.682-.67.823-.124.141-.248.162-.457.052-.209-.104-.883-.326-1.682-1.039-.622-.555-1.042-1.241-1.166-1.45-.124-.209-.013-.322.091-.426.094-.094.209-.248.313-.372.104-.124.141-.209.213-.349.071-.141.035-.266-.018-.37-.053-.104-.471-1.135-.646-1.553-.174-.418-.349-.361-.471-.368-.124-.007-.266-.007-.408-.007-.141 0-.371.053-.565.266-.191.209-.731.714-.731 1.743 0 1.029.749 2.023.853 2.163.104.141 1.473 2.247 3.568 3.149 1.395.604 1.944.658 2.639.555.408-.062 1.236-.504 1.411-.991.174-.487.174-.904.124-.991-.053-.087-.191-.141-.408-.248z"/>
                      </svg>
                    </div>
                  </div>
                  <div className="ml-6">
                    ...
                    <p className="text-gray-600">
                      <a href="https://wa.me/447624482007" target="_blank" rel="noopener noreferrer" className="text-[#7A2325] hover:text-[#7A2325] font-medium">
                        +44 7624 482007
                      </a>
                    </p>
                  </div>
