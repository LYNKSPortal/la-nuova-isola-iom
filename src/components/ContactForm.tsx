          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
              ...
              <p className="text-gray-600 mb-8 text-left">
                This is an enquiry form for feedback or questions. Please use the <a href="/reservations" className="text-brand-600 hover:text-brand-700 font-medium underline">booking form</a> if you would like to make a booking.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      required 
                      className="w-full px-5 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all" 
                      placeholder="John"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    onChange={handleChange}
                    rows={6} 
                    className="w-full px-5 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all resize-none"
                ...
                <button 
                  ...
                  className="w-full bg-brand-600 text-white py-4 px-6 rounded-lg hover:bg-brand-700 transition-all font-semibold text-lg disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                >
                ...
                {submitStatus === 'error' && (
                  <div className="p-6 bg-brand-50 border border-brand-200 rounded-lg text-brand-800">
                    <div className="flex items-center space-x-3">
