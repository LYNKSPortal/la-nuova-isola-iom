          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
              ...
              <p className="text-gray-600 mb-8 text-left">
                This is an enquiry form for feedback or questions. Please use the <a href="/reservations" className="text-gray-600 hover:text-red-700 font-medium underline">booking form</a> if you would like to make a booking.
              </p>
