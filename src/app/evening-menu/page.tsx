          ...
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Isola Bruschetta Caprese <span className="text-xs text-gray-600">(V)</span></h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Pate Della Casa</h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Garlic King Prawns & Queenies</h3>
                <p className="text-sm text-gray-700">King prawns and queenies in a spicy 'Nduja tomato sauce with fresh rocket</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Portobello Milanese <span className="text-xs text-gray-600">(V)</span></h3>
                <p className="text-sm text-gray-700">Breadcrumbed mushroom slices served with a creamy cheese sauce</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Meatballs Arrabbiata</h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Crostino dello Chef</h3>
          ...
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Tagliatelle Ai Gamberoni</h3>
                <p className="text-sm text-gray-700">Ribbon pasta with zucchini cacio e pepe cream, lime zest and king prawns</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Gnocchi Alfredo <span className="text-xs text-gray-600">(V) (GF)</span></h3>
                <p className="text-sm text-gray-700">Baked gnocchi with spinach and Italian cheese & butter sauce</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Penne 'Nduja & Gorgonzola</h3>
                <p className="text-sm text-gray-700">Penne pasta with spicy Calabrian pork sausage and gorgonzola sauce</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Spaghetti Carbonara</h3>
                <p className="text-sm text-gray-700">Classic carbonara with guanciale, pecorino cream, egg and black pepper</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Rigatoni Sugo di Coda <span className="text-xs text-gray-600">(Oxtail Ragù)</span></h3>
                <p className="text-sm text-gray-700">Slow-braised oxtail with tomato sauce, vegetables, wine, herbs and a hint of cacao</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Mezze Maniche Gricia al Porto</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Black Ravioli Queenies</h3>
                <p className="text-sm text-gray-700">Queenie-filled ravioli with spring onion, guanciale, pecorino, cream and garlic</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Linguine allo Scoglio</h3>
                <p className="text-sm text-gray-700">Linguine with mixed seafood, white wine, garlic and spicy tomato sauce</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Risotto ai Funghi e Tartufi <span className="text-xs text-gray-600">(V)</span></h3>
      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Chicken Milanese Al Valdostana</h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Braised Lamb Spezzatino Abruzzo Style <span className="text-xs text-gray-600">(GF)</span></h3>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Sicilian Stuffed Peppers <span className="text-xs text-gray-600">(V)</span></h3>
      ...
      <section className="py-8 md:py-12 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Mini Liqueur Coffee</h3>
                <p className="text-sm text-gray-700">Choose from whiskey, Irish cream, or coffee liqueur</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Pannacotta with Forest Fruits <span className="text-xs text-gray-600">(GF)</span></h3>
                <p className="text-sm text-gray-700">Silky pannacotta topped with fresh forest fruits</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Tiramisu</h3>
                <p className="text-sm text-gray-700">Classic Italian dessert with coffee-soaked ladyfingers and mascarpone cream</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Mango & Coconut Semifreddo <span className="text-xs text-gray-600">(GF)</span></h3>
                <p className="text-sm text-gray-700">Light frozen dessert with tropical mango and coconut flavors</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Lemon Crème Brûlée <span className="text-xs text-gray-600">(GF)</span></h3>
                <p className="text-sm text-gray-700">Silky custard with caramelized sugar topping and fresh lemon flavor</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Ice Cream Affogato</h3>
                <p className="text-sm text-gray-700">Vanilla ice cream drowned in hot espresso with a splash of coffee liqueur</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Chocolate Cake & Pistachio Custard <span className="text-xs text-gray-600">(GF)</span></h3>
                <p className="text-sm text-gray-700">Rich chocolate cake served with creamy pistachio custard</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Manx Ice Cream Selection</h3>
