        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-8 text-base md:text-lg">Take our evening menu with you or view it offline</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a 
                  href="/menu/Isola Evening Menu.pdf" 
                  target="_blank"
                ...
                <a 
                  href="/menu/Isola Evening Menu.pdf" 
                  download="Isola Evening Menu.pdf"
