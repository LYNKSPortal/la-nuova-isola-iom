            ...
            <div className="bg-gray-50 rounded-lg p-8">
              ...
              <ul className="text-gray-600 space-y-3 mb-6">
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-brand-600 mr-3" fill="currentColor" viewBox="0 0 20 20">
              ...
              <button className="w-full bg-brand-600 text-white py-3 rounded-lg hover:bg-brand-700 transition-colors">
