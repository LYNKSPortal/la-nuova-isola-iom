          ...
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Classic Bruschetta <span className="text-xs text-gray-600">(V)</span> — <span className="text-[#7A2325]">£8</span></h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Aubergine alla Parmigiana <span className="text-xs text-gray-600">(V)</span> — <span className="text-[#7A2325]">£10</span></h3>
                <p className="text-sm text-gray-700">Layers of baked aubergine with tomato, basil and melted mozzarella cheese</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Garlic King Prawns <span className="text-xs text-gray-600">(GF)</span> — <span className="text-[#7A2325]">£10</span></h3>
                <p className="text-sm text-gray-700">Succulent king prawns in a spicy tomato sauce with rocket leaves and toasted bread</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Meatballs Arrabbiata — <span className="text-[#7A2325]">£9</span></h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Minestrone Soup <span className="text-xs text-gray-600">(V)</span> — <span className="text-[#7A2325]">£8</span></h3>
                <p className="text-sm text-gray-700">Traditional Italian vegetable soup with seasonal vegetables and herbs</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Cozze Alla Romana — <span className="text-[#7A2325]">£10</span></h3>
          ...
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Penne all'Amatriciana — <span className="text-[#7A2325]">£16</span></h3>
                <p className="text-sm text-gray-700">Penne pasta with guanciale (cured pork cheek), tomato sauce, pecorino romano and chilli</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Rigatoni Carbonara — <span className="text-[#7A2325]">£16</span></h3>
                <p className="text-sm text-gray-700">Classic Roman carbonara with rigatoni, guanciale, pecorino cheese, egg and black pepper</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Tagliatelle Bolognese — <span className="text-[#7A2325]">£16</span></h3>
                <p className="text-sm text-gray-700">Fresh tagliatelle with rich meat ragù, tomato, herbs and garlic</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Lasagne al Forno — <span className="text-[#7A2325]">£16</span></h3>
                <p className="text-sm text-gray-700">Traditional oven-baked lasagne with beef & tomato ragù, béchamel sauce and cheese</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Tortellini alla Panna <span className="text-xs text-gray-600">(V)</span> — <span className="text-[#7A2325]">£16</span></h3>
                <p className="text-sm text-gray-700">Ricotta & spinach tortellini in a creamy sauce with sage and pecorino cheese</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Gnocchi Isola <span className="text-xs text-gray-600">(Vegan)</span> — <span className="text-[#7A2325]">£16</span></h3>
                <p className="text-sm text-gray-700">Homemade gnocchi with tomato & basil sauce and fried aubergine</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Spaghetti alla Puttanesca — <span className="text-[#7A2325]">£16</span></h3>
      ...
      <section className="py-8 md:py-12 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Chicken alla Milanese — <span className="text-[#7A2325]">£16</span></h3>
                <p className="text-sm text-gray-700">Breadcrumbed chicken escalope, pan fried and served with chips and salad</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Mixed Vegetable Omelette — <span className="text-[#7A2325]">£16</span></h3>
                <p className="text-sm text-gray-700">Fresh vegetable omelette served with chips and salad</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Deep Fried Calamari — <span className="text-[#7A2325]">£16</span></h3>
                <p className="text-sm text-gray-700">Crispy deep fried calamari served with chips and salad</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Swordfish alla Milanese — <span className="text-[#7A2325]">£25</span></h3>
                <p className="text-sm text-gray-700">Fresh swordfish with lemon caper butter sauce, garlic rosemary potatoes and salad</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Sirloin Steak alla Toscana <span className="text-xs text-gray-600">(GF)</span> — <span className="text-[#7A2325]">£30</span></h3>
      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Pannacotta Chocolate & Amaretto — <span className="text-[#7A2325]">£8</span></h3>
                <p className="text-sm text-gray-700">Creamy pannacotta infused with rich chocolate and amaretto flavors</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Tiramisu — <span className="text-[#7A2325]">£8</span></h3>
                <p className="text-sm text-gray-700">Classic Italian dessert with coffee-soaked ladyfingers and mascarpone cream</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Mango & Coconut Semifreddo — <span className="text-[#7A2325]">£8</span></h3>
                <p className="text-sm text-gray-700">Light and refreshing frozen dessert with tropical mango and coconut</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Lemon Crème Brûlée — <span className="text-[#7A2325]">£8</span></h3>
                <p className="text-sm text-gray-700">Silky custard with caramelized sugar topping and fresh lemon flavor</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Ice Cream Affogato — <span className="text-[#7A2325]">£8</span></h3>
                <p className="text-sm text-gray-700">Vanilla ice cream drowned in hot espresso with a splash of coffee liqueur</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2 text-xs">Manx Ice Cream Selection — <span className="text-[#7A2325]">£5</span></h3>
