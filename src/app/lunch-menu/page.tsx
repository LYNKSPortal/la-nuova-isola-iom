          ...
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Classic Bruschetta <span className="text-gray-600" style={{fontSize: '20px'}}>(V)</span> — <span style={{fontSize: '22px', color: '#7A2325'}}>£8</span></h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Aubergine alla Parmigiana <span className="text-gray-600" style={{fontSize: '20px'}}>(V)</span> — <span style={{fontSize: '22px', color: '#7A2325'}}>£10</span></h3>
                <p className="text-sm text-gray-700">Layers of baked aubergine with tomato, basil and melted mozzarella cheese</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Garlic King Prawns <span className="text-gray-600" style={{fontSize: '20px'}}>(GF)</span> — <span style={{fontSize: '22px', color: '#7A2325'}}>£10</span></h3>
                <p className="text-sm text-gray-700">Succulent king prawns in a spicy tomato sauce with rocket leaves and toasted bread</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Meatballs Arrabbiata — <span style={{fontSize: '22px', color: '#7A2325'}}>£9</span></h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Minestrone Soup <span className="text-gray-600" style={{fontSize: '20px'}}>(V)</span> — <span style={{fontSize: '22px', color: '#7A2325'}}>£8</span></h3>
                <p className="text-sm text-gray-700">Traditional Italian vegetable soup with seasonal vegetables and herbs</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Cozze Alla Romana — <span style={{fontSize: '22px', color: '#7A2325'}}>£10</span></h3>
          ...
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Penne all'Amatriciana — <span style={{fontSize: '22px', color: '#7A2325'}}>£16</span></h3>
                <p className="text-sm text-gray-700">Penne pasta with guanciale (cured pork cheek), tomato sauce, pecorino romano and chilli</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Rigatoni Carbonara — <span style={{fontSize: '22px', color: '#7A2325'}}>£16</span></h3>
                <p className="text-sm text-gray-700">Classic Roman carbonara with rigatoni, guanciale, pecorino cheese, egg and black pepper</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Tagliatelle Bolognese — <span style={{fontSize: '22px', color: '#7A2325'}}>£16</span></h3>
                <p className="text-sm text-gray-700">Fresh tagliatelle with rich meat ragù, tomato, herbs and garlic</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Lasagne al Forno — <span style={{fontSize: '22px', color: '#7A2325'}}>£16</span></h3>
                <p className="text-sm text-gray-700">Traditional oven-baked lasagne with beef & tomato ragù, béchamel sauce and cheese</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Tortellini alla Panna <span className="text-gray-600" style={{fontSize: '20px'}}>(V)</span> — <span style={{fontSize: '22px', color: '#7A2325'}}>£16</span></h3>
                <p className="text-sm text-gray-700">Ricotta & spinach tortellini in a creamy sauce with sage and pecorino cheese</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Gnocchi Isola <span className="text-gray-600" style={{fontSize: '20px'}}>(Vegan)</span> — <span style={{fontSize: '22px', color: '#7A2325'}}>£16</span></h3>
                <p className="text-sm text-gray-700">Homemade gnocchi with tomato & basil sauce and fried aubergine</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Spaghetti alla Puttanesca — <span style={{fontSize: '22px', color: '#7A2325'}}>£16</span></h3>
      ...
      <section className="py-8 md:py-12 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Chicken alla Milanese — <span style={{fontSize: '22px', color: '#7A2325'}}>£16</span></h3>
                <p className="text-sm text-gray-700">Breadcrumbed chicken escalope, pan fried and served with chips and salad</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Mixed Vegetable Omelette — <span style={{fontSize: '22px', color: '#7A2325'}}>£16</span></h3>
                <p className="text-sm text-gray-700">Fresh vegetable omelette served with chips and salad</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Deep Fried Calamari — <span style={{fontSize: '22px', color: '#7A2325'}}>£16</span></h3>
                <p className="text-sm text-gray-700">Crispy deep fried calamari served with chips and salad</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Swordfish alla Milanese — <span style={{fontSize: '22px', color: '#7A2325'}}>£25</span></h3>
                <p className="text-sm text-gray-700">Fresh swordfish with lemon caper butter sauce, garlic rosemary potatoes and salad</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Sirloin Steak alla Toscana <span className="text-gray-600" style={{fontSize: '20px'}}>(GF)</span> — <span style={{fontSize: '22px', color: '#7A2325'}}>£30</span></h3>
      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Pannacotta Chocolate & Amaretto — <span style={{fontSize: '22px', color: '#7A2325'}}>£8</span></h3>
                <p className="text-sm text-gray-700">Creamy pannacotta infused with rich chocolate and amaretto flavors</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Tiramisu — <span style={{fontSize: '22px', color: '#7A2325'}}>£8</span></h3>
                <p className="text-sm text-gray-700">Classic Italian dessert with coffee-soaked ladyfingers and mascarpone cream</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Mango & Coconut Semifreddo — <span style={{fontSize: '22px', color: '#7A2325'}}>£8</span></h3>
                <p className="text-sm text-gray-700">Light and refreshing frozen dessert with tropical mango and coconut</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Lemon Crème Brûlée — <span style={{fontSize: '22px', color: '#7A2325'}}>£8</span></h3>
                <p className="text-sm text-gray-700">Silky custard with caramelized sugar topping and fresh lemon flavor</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Ice Cream Affogato — <span style={{fontSize: '22px', color: '#7A2325'}}>£8</span></h3>
                <p className="text-sm text-gray-700">Vanilla ice cream drowned in hot espresso with a splash of coffee liqueur</p>
              </div>
              
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="font-medium text-gray-900 mb-2" style={{fontSize: '22px'}}>Manx Ice Cream Selection — <span style={{fontSize: '22px', color: '#7A2325'}}>£5</span></h3>
