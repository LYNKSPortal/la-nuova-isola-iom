      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            {/* Main Message */}
            <h1 className="font-bold text-gray-900 mb-6 text-3xl">
              Reservation Request Received
            </h1>
            
            <div className="bg-gray-50 rounded-xl p-8 mb-8 text-left">
              <h2 className="font-semibold text-gray-900 mb-4 text-xl">What Happens Next?</h2>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="font-medium text-gray-900">We've Received Your Request</h3>
                    <p className="text-gray-600">Your reservation request has been successfully submitted and received by our team.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="font-medium text-gray-900">Peter Will Contact You</h3>
                    <p className="text-gray-600">Peter will be in touch with you via WhatsApp to confirm your booking details and availability.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Once confirmed, you'll receive a final confirmation with all your booking details.</p>
                  </div>
                </div>
              </div>
            </div>
